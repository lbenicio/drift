...
export function TypographyH1({ children, className }: PropsWithChildren<ClassProp>) {
  return <h1 className={cn("scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl", className)}>{children}</h1>;
}

export function TypographyH2({ children, className }: PropsWithChildren<ClassProp>) {
  return <h2 className={cn("scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight transition-colors first:mt-0", className)}>{children}</h2>;
}

export function TypographyH3({ children, className }: PropsWithChildren<ClassProp>) {
  return <h3 className={cn("scroll-m-20 text-2xl font-semibold tracking-tight", className)}>{children}</h3>;
}

export function TypographyH4({ children, className }: PropsWithChildren<ClassProp>) {
...
export function TypographyTable({ children, className }: PropsWithChildren<ClassProp>) {
  return (
...
export function TableHead({ children, className }: PropsWithChildren<ClassProp>) {
  return (
...
export function TableBody({ children, className }: PropsWithChildren<ClassProp>) {
...
export function TableRow({ children, className }: PropsWithChildren<ClassProp>) {
  return <tr className={cn("even:bg-muted m-0 border-t p-0", className)}>{children}</tr>;
}
...
export function TypographyInlineCode({ children, className }: PropsWithChildren<ClassProp>) {
  return <code className={cn("bg-muted relative rounded px-[0.3rem] py-[0.2rem] font-mono text-sm font-semibold", className)}>{children}</code>;
}

export function TypographyLead({ children, className }: PropsWithChildren<ClassProp>) {
  return <p className={cn("text-muted-foreground text-xl", className)}>{children}</p>;
}

export function TypographyLarge({ children, className }: PropsWithChildren<ClassProp>) {
  return <div className={cn("text-lg font-semibold", className)}>{children}</div>;
}

export function TypographySmall({ children, className }: PropsWithChildren<ClassProp>) {
  return <small className={cn("text-sm leading-none font-medium", className)}>{children}</small>;
}

export function TypographyMuted({ children, className }: PropsWithChildren<ClassProp>) {

import { getAllPosts, getAllUsers, PostWithFiles, serverPostToClientPost, ServerPostWithFiles } from "@lib/server/prisma";
...
export default async function AdminPage() {
  ...
  const serializedPosts = posts.map((post) => serverPostToClientPost(post as ServerPostWithFiles)) as PostWithFiles[];
